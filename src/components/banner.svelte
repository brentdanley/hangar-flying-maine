<script lang="ts">
	...
	const nextEventDate = utcToZonedTime(new Date('2023-12-28'), 'America/New_York'); // Replace with the date of the next event
	const nowInEasternTime = utcToZonedTime(new Date(), 'America/New_York');
	const nextEventLink = '/events/2023-12-28'; // Replace with the link to the next event
